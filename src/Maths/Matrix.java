...
public class Matrix {
    ...
    // Konstruktor für eine leere Maths.Matrix der gegebenen Größe
    public Matrix(int size) {
        if (size <= 0) {
            throw new IllegalArgumentException("Die Größe der Maths.Matrix muss größer als 0 sein.");
        }
        this.size = size;
        this.data = new double[size][size];
    }

    //Erstellen einer Maths.Matrix mit einem Array
    ...
    // Methode, um die i-te Zeile der Maths.Matrix zu erhalten
    ...
    // Methode zur Ausgabe der Maths.Matrix auf der Konsole
    @Override
    ...
    // Getter für die Größe der Maths.Matrix
    public int getSize() {
        return size;
    }
    ...
    //rechnung für Multiplikation von Vektor/Maths.Point
    ...
    // Methode zum Transponieren der Maths.Matrix
    ...
    // Methode zur Berechnung des Minors einer Maths.Matrix
    public double minor(int row, int col) {
        return subMatrix(row, col).determinant();
    }

    // Methode zur Berechnung des Kofaktors einer Maths.Matrix
    ...
    // Methode zur Berechnung der inversen Maths.Matrix
    public Matrix inverse() {
        double det = this.determinant();
        if (Math.abs(det) < 1e-9) {
            throw new ArithmeticException("Maths.Matrix ist nicht invertierbar, da ihre Determinante null ist.");
        }
        //Adjunkte erhalten
